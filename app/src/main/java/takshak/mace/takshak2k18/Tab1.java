...
public class Tab1 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        sendsong.setText("Request Song ("+sharedpreferences.getInt(SONGREQCOUNT,15)+")");
        if (sharedpreferences.getInt(SONGREQCOUNT,15) <= 0){
            sendsong.setEnabled(false);
        ...
        protected void onPostExecute(String res) {
            ...
            if (res != null){
                if (res.equals("success")) {
                    ...
                    editor.putInt(SONGREQCOUNT,sharedpreferences.getInt(SONGREQCOUNT,15) - 1 );
                    editor.commit();
                    sendsong.setText("Request Song ("+sharedpreferences.getInt(SONGREQCOUNT,15)+")");
                    Toast.makeText(getActivity(), "Request Sent\nRequest left : "+sharedpreferences.getInt(SONGREQCOUNT,15), Toast.LENGTH_SHORT).show();
                } else {
